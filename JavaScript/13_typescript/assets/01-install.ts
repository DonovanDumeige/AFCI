...
/* 
Par défaut, Typescript compile pour des navigateurs âgés.
On peut lui ajouter de compiler pour une version moderne
...
Il faut pour cela ajouter l'option 
*"noEmitOnerror" à true 
dans le fichier json
*/
...
/* 
Typescript peut parfois nous donner de bonnes indications sur l'erreur en passant la souris dessus.
Si on souhaite, on peut ajouter l'option 
*"strict" à true 
pour que TS nous indique la moindre petite erreur.
*/