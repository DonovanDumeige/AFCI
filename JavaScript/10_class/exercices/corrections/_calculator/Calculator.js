...
export default class Calculator{
    ...
    chooseOperation(e){
        ...
        if(this.previousOperand !==""){ //si notre nombre précédent n'est pas vide, lance compute()
            this.compute();
        }
    ...
    compute(){
        let total;
        const prev = parseFloat(this.previousOperand) //prend en compte les virgules
    ...
    getDisplayNumber(number){
        ...
        if(isNaN(intDigits)){
            ...
            //transforme les nombre en chaine de caractères selon l'affichage français.
        } if(decimDigits != null){
